    ...
    <Container>
      ...
      <Row className="justify-content-center">
        <Col className="my-3" xs={12} sm={10} md={8} lg={6} xl={5}>
          ...
          <S.AboutCardText>
            LC TROOP ENTERTAINMENT AS is a record label / collective based in
            Oslo, Norway, founded by artist Young Cisto.
          </S.AboutCardText>
          <S.AboutCardText>
            While striving to become one of the greatest entertainment companies
            worldwide, the company offers a wide range of services from studio
            access for song recording / podcast recording, videography,
        ...
        <Col className="my-3" xs={12} sm={10} md={8} lg={6} xl={5}>
          ...
          <S.AboutCardText>
            Our goal is to entertain the masses & individuals with talents from
            our roster while creating job opportunities in the society.
          </S.AboutCardText>
        </Col>
      </Row>
    </Container>
